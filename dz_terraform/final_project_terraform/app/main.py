...
db_user = os.getenv('DB_USER', 'administrator')   #os.environ.get
...
def get_client_ip(request: Request):   # def get_client_ip(x_real_ip: Optional[str] = Header(None)):
    return request.client.host                                          #     return x_real_ip



# --- 5. Основной эндпоинт ---
@app.get("/")
def index(request: Request, ip_address: str = Depends(get_client_ip)):
